...
public class Segment2 implements SegmentIntersection {
    ...
    public boolean containsPoint(Point2 p) {
        ...
        /*
            0. Вырожденный случай: отрезок на самом деле является одной точкой.
        ...
        /*
            1. Проверяем, что точка лежит на той же прямой.
        ...
        /*
            2. Проверяем, что точка не "до" начала отрезка.
        ...
        /*
            3. Проверяем, что точка не "после" конца отрезка.
    ...
    public Optional<SegmentIntersection> intersect(Segment2 other) {
        ...
        /*
            1. Обрабатываем вырожденные случаи:
        ...
        /*
            2. Если векторное произведение почти ноль, отрезки параллельны.
         */
        ...
        /*
            4. Непараллельные прямые. Находим параметры пересечения:
         */
